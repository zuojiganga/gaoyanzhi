...
[manager.requestSerializer setValue:@"2.2"  forHTTPHeaderField: @"te_method"];
[manager.requestSerializer setValue:@"moa"forHTTPHeaderField:@"party_id"];
NSDictionary *dic2 = manager.requestSerializer.HTTPRequestHeaders;
NSLog(@"manager.requestSerializer.HTTPRequestHeaders:  %@",dic2.description);
NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"http"]];
request.HTTPMethod = @"POST";
[request addValue:@"doAction" forHTTPHeaderField: @"te_method"];
[request addValue:@"application/json" forHTTPHeaderField:@"Content-Type"];
[request addValue:@"2.2" forHTTPHeaderField:@"te_version"];
[request addValue:@"moa" forHTTPHeaderField:@"party_id"];
[request setTimeoutInterval:15];

NSDictionary *dic = request.allHTTPHeaderFields;

NSLog(@";asdjfk;lsaj;lkfjas;ldkfj;alskdjf;lk: $*******    %@",dic.description);
*/
